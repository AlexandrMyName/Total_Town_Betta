...
public class lb_BirdController : MonoBehaviour {
	...
	{
		WaitForSeconds ws = new WaitForSeconds(SpawnAutoCountTime);
		while (true)
		{
			yield return ws;
			SpawnAmount(SpawnAutoCountBird);
		}
	}
	[SerializeField] private int SpawnAutoCountBird;
    [SerializeField] private int SpawnAutoCountTime;
    void OnEnable(){
